 ...
 * @param {string} n     - icon key from PATHS
 * @param {number} s     - size in px (default 20)
 * @param {string} c     - stroke color (default "currentColor")
 * @param {number} sw    - stroke width (default 2)
 * @param {string} fill  - fill color (default "none")
 */
const Icon = ({ n, s = 20, c = "currentColor", sw = 2, fill = "none" }) => (
  <svg
    width={s}
    height={s}
    viewBox="0 0 24 24"
